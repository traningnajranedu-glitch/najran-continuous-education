...
export async function POST(request) {
  try {
    ...
    const enrichedMessage = [
      ...
      "",
      "تعليمات صارمة:",
      "استخدم المرجع فقط لتثبيت الحقائق. لا تخترع شرطًا أو إجراءً أو موعدًا أو رقمًا أو جهة غير موجودة في المرجع. إذا لم تكن المعلومة موجودة، صرّح بعدم توفرها في المصادر المتصلة."
    ].join("\n");
